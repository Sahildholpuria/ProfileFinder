...
def parse_arguments(self):
    parser = argparse.ArgumentParser(description='ProfileFinder is an OSINT tool that allows you to find the differents social accounts, domains and emails used by a person')
